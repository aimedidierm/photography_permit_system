...
<div class="py-11 sm:ml-64">
    <div class="flex justify-between">
        ...
        <a href="/register/report/payments"
            class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-2 py-2 mr-4 mb-2 mt-10 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
            Generate report</a>
    </div>
    <div class="px-4">
