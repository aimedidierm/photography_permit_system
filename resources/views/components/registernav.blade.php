            ...
            <ul
                ...
                <li>
                    <a href="/register/applications"
                        class="block py-2 pl-3 pr-4 {{ request()->is('register/applications') ? 'text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:dark:text-blue-500' : '' }} md:p-0 dark:text-white"
                        aria-current="page">Applications</a>
                </li>
                <li>
                    <a href="/register/payments"
                        class="block py-2 pl-3 pr-4 {{ request()->is('register/payments') ? 'text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:dark:text-blue-500' : '' }} md:p-0 dark:text-white">Payments</a>
                </li>
                <li>
                    <button type="button" data-dropdown-toggle="language-dropdown-menu"
                        class="block py-2 pl-3 pr-4 {{ request()->is('register/registers') || request()->is('register/applicants') ? 'text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:dark:text-blue-500' : '' }} md:p-0 dark:text-white">
                        Accounts
                    </button>
                ...
                <li>
                    <a href="/register/settings"
                        class="block py-2 pl-3 pr-4 {{ request()->is('register/settings') ? 'text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:dark:text-blue-500' : '' }} md:p-0 dark:text-white">Settings</a>
                </li>
                <li>
                    <a href="/logout"
